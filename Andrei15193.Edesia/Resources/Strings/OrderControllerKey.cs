...
{
	internal static class OrderControllerKey
	{
		internal const string AddressDetailsTextBox_DisplayName = "AddressDetailsTextBox_DisplayName";
		internal const string AddressDetailsTextBox_Hint = "AddressDetailsTextBox_Hint";
		internal const string AddressDetailsTextBox_MissingValue = "AddressDetailsTextBox_MissingValue";
		...
		internal const string DeliveredOrdersLabel_DisplayName = "DeliveredOrdersLabel_DisplayName";
		...
		internal const string SelectedStreetListBox_NoSelectedItem = "SelectedStreetListBox_NoSelectedItem";
		internal const string SubmitOrderButton_DisplayName = "SubmitOrderButton_DisplayName";
		internal const string ThanksNoticeAuthor = "ThanksNoticeAuthor";
