namespace Andrei15193.Edesia.Resources.Strings
{
	internal static class UserControllerKey
	{
		...
		internal const string FirstNameTextBox_MissingValue = "FirstNameTextBox_MissingValue";
		internal const string LanguageDropDown_DisplayName = "LanguageDropDown_DisplayName";
		internal const string LastNameTextBox_DisplayName = "LastNameTextBox_DisplayName";
		internal const string LastNameTextBox_Hint = "LastNameTextBox_Hint";
		internal const string LastNameTextBox_InvalidValue = "LastNameTextBox_InvalidValue";
		internal const string LastNameTextBox_MissingValue = "LastNameTextBox_MissingValue";
		internal const string LoginButton_DisplayName = "LoginButton_DisplayName";
		...
		internal const string ManageDeliveryZoneButton_DisplayName = "ManageDeliveryZoneButton_DisplayName";
